...
Finally restart VS Code. Now type some invalid css code, see if the warnings are showing up in **Problems** panel. Try to commit this file, the process will not complete as the code contains invalid code.
